        ...
        <>
         <div className="flex justify-between border-b border-b-midGray pb-5 mt-5">
          <div className="flex flex-col">
            <span style={{fontFamily:'Shabnam'}} className="font-IRSans text-[#0D296E] text-lg font-bold sm:text-xs">
              فراموشی رمزعبور اکانت
            </span>
            <span style={{fontFamily:'Shabnam'}} className="font-IRSans text-darkGray mt-2 sm:text-xs">
              #1256
            </span>
          </div>
          <div className="flex flex-col justify-end items-end">
            <p style={{fontFamily:'Shabnam'}} className="font-IRSans text-[#0d296e] text-lg font-bold sm:text-xs">
              وضعیت تیکت : 
              <span style={{fontFamily:'Shabnam'}} className="text-darkGray font-medium sm:text-xs">
                پاسخ داده شده
              </span>
            </p>
            <p style={{fontFamily:'Shabnam'}} className="font-IRSans text-[#0d296e] text-lg font-bold mt-2 sm:text-xs">
              زمان ایجاد : 
              <span style={{fontFamily:'Shabnam'}} className="text-darkGray font-medium sm:text-xs">
                ۰۲/۰۲/۲۸
              </span>
         ...
         <div className="flex items-end my-8 ">
            ...
            <div className="w-[90%] mr-3">
              <span style={{fontFamily:'Shabnam'}} className="font-IRSans text-black mb-3">
                پیام
              </span>
         ...
         <div className="w-[80%] bg-lightBlue min-h-[200px] ml-3 rounded-lg p-5 overflow-y-auto">
              <div className="w-full flex justify-end border-b border-b-black pb-4">
                <p style={{fontFamily:'Shabnam'}} className="font-IRSans text-black font-bold text-sms">
                  پشتیبانی فنی | ۰۱/۰۳/۱۲
                </p>
              </div>
              <p style={{fontFamily:'Shabnam'}} className="font-IRSans text-black font-normal text-base m-4">
