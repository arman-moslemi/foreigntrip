...
const UserReportList = () =>{
  const tableRow =[
    ...
    <tr key={tableRow.id} className="border-b border-b-borderGray">
      ...
      <td style={{fontFamily:'Shabnam'}} className="py-4 text-sm text-right px-4 font-IRsans">{tableRow.subject}</td>
      <td style={{fontFamily:'Shabnam'}} className="py-4 text-sm text-center px-4 font-IRsans" >{tableRow.location}</td>
      <td style={{fontFamily:'Shabnam'}} className="py-4 text-sm text-center px-4 font-IRsans"  >{tableRow.status}</td>
      <td style={{fontFamily:'Shabnam'}} className="py-4 text-sm text-center px-4 font-IRsans">{tableRow.function}</td>
      </tr> 
    )
    return(
        <>
  ...
  <thead className="bg-darkGray h-11 rounded-t-2xl  w-full whitespace-nowrap overflow-x-scroll" style={{borderRadius:'20px'}}> 
    <tr className="text-white  p-6 whitespace-nowrap overflow-x-scroll" style={{borderRadius:'20px'}}>
      ...
      <th className="text-center font-IRsans md:px-4 pl-4" style={{fontFamily:'Shabnam'}} >مشاهده</th>
    </tr>
  </thead>
  <tbody>
   {tableBody}
