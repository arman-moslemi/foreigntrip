  ...
  const tableRow =[
    ...
    return(
        ...
        <div className="flex xl-lg:flex-col xl-lg:items-end justify-between items-center mt-8 flex-wrap ">
            <div className="flex xs:flex-col xs:items-start items-center flex-wrap xl-lg:w-[100%]">
                <span style={{fontFamily:'Shabnam'}} className="  text-mainColor font-bold text-base ml-4 xl-lg:ml-0 xl-lg:w-[27%] lg:w-[31%] lg-md:w-[38%] md:w-[27%] md-sm:w-[31%] sm-xs:w-[36%] xs-510:w-[40%] xs:w-[100%] xs:mb-3">
                   جستجو در بین گزارشات
                </span>
                <input type="text" className="border rounded-full w-80 xl-lg:w-[73%] lg:w-[69%] lg-md:w-[62%] md:w-[73%] md-sm:w-[69%] sm-xs:w-[64%] xs-510:w-[60%] xs:w-[100%] border-midGray px-4 py-1.5 " placeholder="جستجو کنید ..."/>
            </div>
