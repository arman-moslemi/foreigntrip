...
const [showAlert,setShowAlert] = React.useState(false);
    return (
        ...
        <p style={{fontFamily:'Shabnam'}} className="  font-bold text-black">
            تایید درخواست و بارگزاری امضاها
        </p>

        <div className="flex items-center my-5 flex-wrap">
            <span style={{fontFamily:'Shabnam'}} className="  text-black text-sm">این فرم از نظر 
              <span style={{fontFamily:'Shabnam'}} className="  text-mainColor mx-2 font-bold">    آقای احمدی مسئول شماره یک  </span>
                مورد تایید  :
            </span>
    ...
    <div class="">
        <div class="flex items-center pl-3">
        <label for="horizontal-list-radio-license" style={{fontFamily:'Shabnam'}} className="  text-black  ml-4 text-sm">نیست</label>
              ...
              <div className="border-0 rounded-lg p-2 shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="flex items-center justify-center  border-solid border-slate-200 rounded-b mb-4">
                  ...
                  style={{fontFamily:'Shabnam'}}
                    className=" float-left   text-white flex bg-mainColor items-center rounded-md shadow-blueShadow uppercase px-12 py-2 mx-1 outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                    type="button"
                  ...
                  <button
                  style={{fontFamily:'Shabnam'}}
                    className=" float-left   text-black flex bg-transparent items-center rounded-md  uppercase px-3 py-2 mx-1 outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                    type="button"
                    onClick={() => setShowModal(false)}
                  >
                اصلاح
          ...
          >
            <div className="relative w-[20%] md:w-[90%] my-5 mx-auto max-w-3xl">
              ...
              <div className="border-0 rounded-lg p-2 shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="flex items-start justify-between p-4 border-b border-solid border-b-midGray rounded-t">
                  <span style={{fontFamily:'Shabnam'}} className="text-base font-bold   text-black">
                   هشدار!
                  </span>
                ...
                <div className="flex items-center justify-center  border-solid border-slate-200 rounded-b mb-4">
                  <button
                    className=" float-left   text-black flex bg-transparent items-center rounded-md shadow-blueShadow uppercase px-3 py-2 mx-1 outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                    type="button"
                    onClick={() => setShowModal(false)}
                  >
                  بستن
                  ...
                  <button
                    className=" float-left   text-white flex bg-mainColor items-center rounded-md shadow-blueShadow uppercase px-3 py-2 mx-1 outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                    type="button"
                    onClick={() => setShowModal(false)}
                  >
                 اصلاح
