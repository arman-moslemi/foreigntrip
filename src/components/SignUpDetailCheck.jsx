       ...
       <div className="flex justify-center">
        ...
        <divn className="flex justify-end">
                ...
                >
                    ...
                    className="mr-5 bg-[#3AB50E] hover:bg-white hover:text-[#3AB50E] hover:border-2 hover:border-[#3AB50E] w-[162px] rounded-md h-[40px] flex justify-center items-center text-white  font-IRsans font-medium text-base shadow-greenShadow">
                       تایید درخواست
                    </button>
        </divn>
        {
          ...
          <div className="relative w-auto my-5 mx-auto max-w-2xl">
            ...
            <div className="border-0 rounded-md p-2 shadow-md relative flex flex-col w-full bg-white outline-none focus:outline-none">
             ...
             شما میتوانید علت رد درخواست ثبت نام مامور اعزامی را اینجا بنویسید تا به ایشان نمایش داده شود
              ...
              <textarea id="message" rows="3" class="block p-2.5 mt-1 mx-6 font-IRsans w-[90%] text-sm text-gray-900 bg-gray-50 rounded border  border-borderGray focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="توضیحات خود را اینجا بنویسید..."></textarea>
