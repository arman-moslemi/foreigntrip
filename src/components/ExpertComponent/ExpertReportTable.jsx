...
const tableRow =[
  ...
  <tr key={tableRow.id} className="border-b border-b-borderGray">
    ...
    <td className="py-4 text-sm text-right px-4  " style={{fontFamily:'Shabnam'}}>{tableRow.requset?.travelTopic}</td>
    <td className="py-4 text-sm text-center px-4  "style={{fontFamily:'Shabnam'}} >{tableRow.request?.destinationCity}</td>
    <td className="py-4 text-sm text-center px-4  " style={{fontFamily:'Shabnam'}} >{tableRow?.request?.requestStatus?.requestStatusTitle}</td>
    <td className="py-4 text-sm text-center px-4  "style={{fontFamily:'Shabnam'}}> <Link style={{fontFamily:'Shabnam'}}  to={'/expert/reportView'}>
                <Eye/>
                </Link></td>
    </tr> 
  )
