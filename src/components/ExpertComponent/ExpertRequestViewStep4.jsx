...
خیر
          ...
          <div className="opacity-25 fixed inset-0 z-40 bg-black"></div>
           ...
           <>
            ...
            className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none"
          >
            <div className="relative w-[40%] my-5 mx-auto max-w-3xl">
              ...
              <div className="border-0 rounded-lg p-2 shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="relative p-6 flex-auto">
                 ...
                 تایید درخواست مامور اعزامی با موفقیت انجام شد و این درخواست برای مقام بالاتر ارسال گردید.
                  </p>
                </div>
                ...
                <div className="flex items-center justify-center  border-solid border-slate-200 rounded-b mb-4">
                  <button style={{fontFamily:'Shabnam'}} 
                    className=" float-left flex bg-transparent items-center rounded-md  uppercase px-3 py-2 mx-1 outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                    type="button"
...
export default ExpertRequestViewStep4;