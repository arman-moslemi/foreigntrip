    ...
    return (
        <div>
                ...
                <div className="flex flex-col w-[100%]  mb-4  md:w-[100%] md:mx-0">
                    ...
                    <div class="relative mt-3">
                        ...
                        <textarea style={{fontFamily:'Shabnam'}}
                            ...
                            disabled="true"
                            id="input-group-1"
                            class="pr-9   text-right right-6 bg-white border border-gray-300 text-black text-sm rounded-md  focus:ring-mainColor focus:border-mainColor block w-full pl-10 p-2.5  "
            ...
            <Link to={'/signUpDone'} style={{fontFamily:'Shabnam'}}
                className="w-[60%] mx-auto flex justify-center items-center h-12 bg-mainColor shadow-blueShadow mt-10   text-white text-xl font-medium rounded-lg hover:bg-lightBlue hover:text-mainColor">
                ثبت نام
            </Link>
