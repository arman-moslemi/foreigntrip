...
const InternationalReportTable = () =>{
...
const tableRow =[
  {
   ...
   function: 
                <Link style={{fontFamily:'Shabnam'}}  to={'/internationalAdmin/reportView'}>
                <Eye/>
                </Link>
  ...
  },
  {
   ...
   function:  <Link style={{fontFamily:'Shabnam'}}  to={'/internationalAdmin/reportView'}>
   <Eye/>
  </Link>
  },
  {
...
export default InternationalReportTable;