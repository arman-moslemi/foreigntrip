...
const SupervisorTicketListTable = () =>{
...
const tableRow =[
  {
   ...
   function: <Link style={{fontFamily:'Shabnam'}}  className="flex justify-center" to={'/supervisor/ticketView'}>
   <Eye/>
   </Link>
...
export default SupervisorTicketListTable;