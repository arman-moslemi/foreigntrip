    ...
    return (
        <div className="border border-borderGray rounded-md pt-10 px-5 py-5 mt-7">
            ...
            <ReportBox/>
            {
              ...
              <button onClick={() => setShowSendModal(true)} className="mt-5 min-w-[120px] h-8 px-2 bg-mainColor shadow-blueShadow   text-white text-sm rounded-lg hover:bg-lightBlue hover:text-mainColor ">
               ارسال
              </button>
              {showSendModal ?
           <>
          ...
          <div className="opacity-25 fixed inset-0 z-40 bg-black"></div>
           ...
           :null
                ...
                onClick={()=>setShow(true)
                    ...
                    <button onClick={() => setShowSuccessModal(true)} className="mr-5 bg-[#3AB50E] hover:bg-white hover:text-[#3AB50E] hover:border-2 hover:border-[#3AB50E] w-[162px] rounded-md h-[40px] flex justify-center items-center text-white    font-medium text-base shadow-greenShadow">
                       تایید درخواست
                    </button>
                    {showSuccessModal ?
           <>
