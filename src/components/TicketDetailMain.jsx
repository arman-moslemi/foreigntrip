        ...
        <>
         <div className="flex justify-between border-b border-b-midGray pb-5 mt-5">
          <div className="flex flex-col">
            <span className="font-IRSans text-[#0D296E] text-lg font-bold sm:text-xs">
              فراموشی رمزعبور اکانت
            </span>
            <span className="font-IRSans text-darkGray mt-2 sm:text-xs">
              #1256
            </span>
          </div>
          <div className="flex flex-col justify-end items-end">
            <p className="font-IRSans text-[#0d296e] text-lg font-bold sm:text-xs">
              وضعیت تیکت : 
              <span className="text-darkGray font-medium sm:text-xs">
                پاسخ داده شده
              </span>
            </p>
            <p className="font-IRSans text-[#0d296e] text-lg font-bold mt-2 sm:text-xs">
              زمان ایجاد : 
              <span className="text-darkGray font-medium sm:text-xs">
                ۰۲/۰۲/۲۸
              </span>
