...
const PassportForm = () =>{
    ...
    return(
        <>
        <p style={{fontFamily:'Shabnam'}} className="text-black   font-bold">
            فرم زیر را با دقت پر کنید.
        </p>
        <div className="flex items-center mt-3">
            <Info/>
            <p style={{fontFamily:'Shabnam'}} className="text-darkGray   font-medium text-sm mr-2">
            تمام فیلدهای لاتین را با حروف بزرگ پر کنید.
        </p>
        </div>
        <div className="mt-5 flex flex-wrap items-center">
            <div className="w-[250px] flex flex-col mb-5 mx-3">
                <span style={{fontFamily:'Shabnam'}} className="text-black   text-sm font-medium">
                    نام به فارسی
                </span>
                <input type="text" placeholder="نام به فارسی" className="  text-xs text-midGray border border-borderGray rounded-md p-3 mt-2"/>
            </div>
            <div className="w-[250px] flex flex-col mb-5 mx-3">
                <span style={{fontFamily:'Shabnam'}} className="text-black   text-sm font-medium">
            ...
            <div className="w-[250px] flex flex-col mb-5 mx-3">
                <span style={{fontFamily:'Shabnam'}} className="text-black   text-sm font-bold">
                   تاریخ تولد
                </span>
                <input type="text" placeholder="نام به فارسی" className="  text-xs text-midGray border border-borderGray rounded-md p-3 mt-2"/>
            </div>
    ...
    <div class="">
        ...
        <label for="horizontal-list-radio-license" className="  text-black text-xs font-medium ml-4">موقت</label>
    ...
    <div class="">
        <div class="flex items-center pl-3">
        <label for="horizontal-list-radio-license" className="  text-black text-xs font-medium ml-4">ثابت</label>
    ...
    <div class="">
        <div class="flex items-center pl-3">
        <label for="horizontal-list-radio-license" className="  text-black text-xs font-medium ml-4">مجرد</label>
    ...
    <div class="">
        <div class="flex items-center pl-3">
        <label for="horizontal-list-radio-license" className="  text-black text-xs font-medium ml-4">متاهل</label>
        ...
        <label for="dropzone-file" class="mt-2 flex flex-col items-center justify-center w-[100%] md:w-full h-12 border-2 border-borderGray border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
            <div class="flex flex-col items-center justify-center pt-5 pb-6  ">
                ...
                <p style={{fontFamily:'Shabnam'}} class="mb-0 text-xs text-gray-500 dark:text-gray-400"><span style={{fontFamily:'Shabnam'}} class="font-normal   ">انتخاب فایل</span></p>
        ...
        <label for="dropzone-file" class="mt-2 flex flex-col items-center justify-center w-[100%] md:w-full h-12 border-2 border-borderGray border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
           ...
           <div className="w-[250px] flex flex-col mb-5 mx-3">
              ...
              <button onClick={() => setShowSuccessModal(true)} className="mt-6 min-w-[160px] h-12 px-2 bg-mainColor shadow-blueShadow   text-white text-md font-semibold rounded-lg hover:bg-lightBlue hover:text-mainColor">
              ثبت درخواست
              </button>
