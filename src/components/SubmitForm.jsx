    ...
    return(
      <div>
          ...
          <div class="mb-3">
              ...
              <input class="shadow appearance-none border text-sm font-IRsans border-[#CCCCCD] rounded w-[40%] py-2 px-3 text-[#CCCCCD] mb-3 leading-tight focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" id="password" type="text" placeholder="موضوع سفر خود را اینجا بنویسید..."/>
        ...
        <label for="dropzone-file" class="flex flex-col items-center justify-center w-[40%] h-64 border-2 border-[#CCCCCD] border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
