  ...
  const [showSuccessModal, setShowSuccessModal] = React.useState(false);
    ...
    return(
      <div>
          ...
          <p style={{fontFamily:'Shabnam'}} className="  text-black font-bold text-base mt-5">
            شما موطف هستید بعد از اتمام سفر خود٬گزارش دستاورد خود از این سفر را در سامانه بارگذاری کنید.
          </p>
          <div className="flex items-center mt-2">
            <Info/>
            <p style={{fontFamily:'Shabnam'}} className="  text-[#5C5F66] font-bold text-sm mr-2">
            در صورت عدم بارگذاری گزارش دستاورد و یا عدم بارگذاری گزارش مناسب برای سفر آتی اجازه سفر صادر نمی شود.
          </p>
          
          </div>
          <div class="mb-3">
              <label style={{fontFamily:'Shabnam'}} class="block text-gray-700 text-sm font-bold mt-4 mb-2  " for="password">
                موضوع سفر
              </label>
              <input class="shadow appearance-none border text-sm   border-[#CCCCCD] rounded md:w-full w-[40%] py-2 px-3 text-[#CCCCCD] mb-3 leading-tight focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" id="password" type="text" placeholder="موضوع سفر خود را اینجا بنویسید..."/>
        ...
        <label style={{fontFamily:'Shabnam'}} for="dropzone-file" class="flex flex-col items-center justify-center w-[40%] md:w-full h-64 border-2 border-[#CCCCCD] border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
            <div class="flex flex-col items-center justify-center pt-5 pb-6  ">
                ...
                <p style={{fontFamily:'Shabnam'}} class="mb-2 text-sm text-gray-500 dark:text-gray-400"><span style={{fontFamily:'Shabnam'}} class="font-semibold  ">انتخاب فایل</span></p>
                <p style={{fontFamily:'Shabnam'}} class="text-xs text-gray-500 dark:text-gray-400  ">JPG,JPEG,PNG,PDF,TXT</p>
            </div>
            <input id="dropzone-file" type="file" class=" md:hidden" />
        </label>
        </div>  
        
              <button style={{fontFamily:'Shabnam'}} onClick={() => setShowSuccessModal(true)} className="mt-12 min-w-[120px] h-8 px-2 bg-mainColor shadow-blueShadow   text-white text-sm rounded-lg hover:bg-lightBlue hover:text-mainColor">
               ارسال
              </button>
              {showSuccessModal ?
           <>
