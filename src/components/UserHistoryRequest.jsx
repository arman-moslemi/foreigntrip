...
const tableRow =[
  ...
  <thead className="bg-darkGray h-11 rounded-t-2xl" style={{borderRadius:'20px'}}> 
    <tr className="text-white  p-6" style={{borderRadius:'20px'}}>
      <th className="text-right pr-4 font-IRsans">ردیف</th>
      <th className="text-right font-IRsans">تاریخ سفر</th>
      <th className="text-right font-IRsans">موضوع سفر</th>
      <th className="text-center font-IRsans">کشور مقصد</th>
      <th className="text-center font-IRsans">وضعیت</th>
      <th className="text-center font-IRsans">عملیات</th>
    </tr>
  </thead>
  <tbody>
   {tableBody}
