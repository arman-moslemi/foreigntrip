    ...
    return(
        <>
         <div className="mt-20 border-b border-b-borderGray">
            ...
            <br/>
            <p style={{fontFamily:'Shabnam'}} className="  text-xs font-medium text-black leading-8">
            ...
            <div className="flex flex-wrap items-center mt-5">
                <div className="flex ml-5 items-center bg-lightBlue px-6 h-[45px] justify-between rounded-full mb-5">
                    <span style={{fontFamily:'Shabnam'}} className="text-mainColor   text-xs font-medium">
