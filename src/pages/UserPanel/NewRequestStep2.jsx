...
const NewRequestStep2 = () => {
    return (
        <div
            className="w-full h-full bg-lightGray py-10 px-20 lg:px-8 md:p-0  lg:h-full"
            style={{
            direction: 'rtl'
        }}>
            ...
            <div className="flex md:block">
                <AgentRightMenu/>
                <div
                    className="bg-white rounded-tr-none rounded-br-none rounded-tl-2xl rounded-bl-2xl my-10 w-[80%] min-w-[500px] lg:min-w-[450px] md:min-w-[95%] xl:p-5 lg:p-1 md:w-[95%] md:rounded-xl md:mx-auto">
                    <div className="border-b border-b-midGray border-dashed">
                        <div className="flex-col pb-5 px-12 xl-1400:px-4 pt-12 ">
                    ...
                    <div className="px-12 xl-1400:px-4 pb-12 ">
