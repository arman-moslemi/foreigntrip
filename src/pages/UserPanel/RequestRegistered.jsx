    ...
    return(
        ...
        <div className="flex md:block">
                ...
                <span style={{fontFamily:'Shabnam'}} className="  text-mainColor mr-3 font-bold">
                    ...
                    <p style={{fontFamily:'Shabnam'}} className="text-black   font-bold text-sm text-center w-[400px] mx-auto mt-10 mb-4 xs:w-[90%] xs:mx-auto">
                    درخواست شما با موفقیت ثبت شد.
                    پس از بررسی اطلاعات توسط اداره امور بین الملل ،
                    نتیجه ی آن در قسمت مشاهده ی تاریخچه درخواست ها قابل رویت است.
                    </p>
                    <p style={{fontFamily:'Shabnam'}} className="text-mainColor   font-bold text-sm text-center w-[400px] mx-auto  mb-4 xs:w-[90%] xs:mx-auto">
                    کد رهگیری  : 1256457896
                    </p>
                    <Link style={{fontFamily:'Shabnam'}}  to={`/requestHistory`}>
                        <button className="mx-auto block w-[240px] h-10 xs:w-[80%] xs:mx-auto xs:text-xs bg-mainColor shadow-blueShadow mt-7   text-white text-lg rounded-lg hover:bg-lightBlue hover:text-mainColor">
