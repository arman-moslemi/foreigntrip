...
const SignUpDone = () =>{
    ...
    return(
        <div className="w-full h-screen bg-lightGray p-16 sm:p-2" style={{direction:'rtl'}}>
            ...
            <div className="bg-white flex flex-col w-[45%] p-16 sm:p-6 rounded-xl mx-auto shadow-blackShadow my-8 xl:w-[80%] lg:w-[80%] md:w-[100%] sm:w-[100%] xs:w-[100%]">
              <p style={{fontFamily:'Shabnam'}}  className="text-right font-bold text-black  sm:text-sm">
                ...
                <p style={{fontFamily:'Shabnam'}}  className="  text-black text-right sm:text-sm">
