    ...
    return(
        <div className="w-full h-screen bg-lightGray sm:p-2 p-16 " style={{direction:'rtl'}}>
            ...
            <div className="bg-white w-[32%] p-16 sm:p-6 rounded-xl mx-auto shadow-blackShadow my-8 xl:w-[80%] lg:w-[80%] md:w-[100%] sm:w-[100%] xs:w-[100%]">
              <p className="text-right font-bold text-black font-IRsans" style={{fontFamily:'Shabnam'}}>
                 تغییر رمز عبور
                </p>
          ...
          <div class="relative my-6">
              ...
              <input type="text" id="input-group-1" style={{fontFamily:'Shabnam'}} class="pr-9 font-IRsans text-right right-6 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-md my-5 focus:ring-mainColor focus:border-mainColor block w-full pl-10 p-2.5  " placeholder="شماره تماس"/>
